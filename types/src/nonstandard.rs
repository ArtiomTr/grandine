...
///
/// Contains only the in-memory list representation and methods for correctly operating on
/// it. This allows consumers to implement their own serialization and hashing, without
/// caring about list internals.
#[derive(Clone, Debug, Default, Derivative)]
