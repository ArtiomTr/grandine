...
use types::{
    ...
    preset::Preset,
    traits::{BeaconState as _, SszValidatorList as _},
};
...
mod spec_tests {
    ...
    #[test_resources(
        "consensus-spec-tests/tests/mainnet/deneb/epoch_processing/justification_and_finalization/*/*"
    )]
    ...
    #[test_resources(
        "consensus-spec-tests/tests/minimal/deneb/epoch_processing/justification_and_finalization/*/*"
    )]
    ...
    #[test_resources("consensus-spec-tests/tests/mainnet/deneb/epoch_processing/*/*/*")]
    fn mainnet_epoch_processing(case: Case) {
        run_epoch_case::<Mainnet>(case);
    }

    #[test_resources("consensus-spec-tests/tests/minimal/deneb/epoch_processing/*/*/*")]
