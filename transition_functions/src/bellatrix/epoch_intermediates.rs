...
mod spec_tests {
    ...
    #[test_resources("consensus-spec-tests/tests/mainnet/bellatrix/rewards/*/*/*")]
    fn mainnet(case: Case) {
        run_case::<Mainnet>(case).expect("bellatrix rewards test should not return an error")
    }

    #[test_resources("consensus-spec-tests/tests/minimal/bellatrix/rewards/*/*/*")]
    fn minimal(case: Case) {
        run_case::<Minimal>(case).expect("bellatrix rewards test should not return an error")
    }
