...
pub fn process_proposer_lookahead<P: Preset>(
    ...
    let last_epoch_start = proposer_lookahead.len().try_sub(P::SlotsPerEpoch::USIZE)?;
...
mod spec_tests {
    ...
    #[test_resources(
        "consensus-spec-tests/tests/mainnet/fulu/epoch_processing/justification_and_finalization/*/*"
    )]
    ...
    #[test_resources(
        "consensus-spec-tests/tests/minimal/fulu/epoch_processing/justification_and_finalization/*/*"
    )]
