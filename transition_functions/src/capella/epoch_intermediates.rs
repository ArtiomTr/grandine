...
mod spec_tests {
    ...
    #[test_resources("consensus-spec-tests/tests/mainnet/capella/rewards/*/*/*")]
    fn mainnet(case: Case) {
        run_case::<Mainnet>(case).expect("capella rewards test should not return an error")
    }

    #[test_resources("consensus-spec-tests/tests/minimal/capella/rewards/*/*/*")]
    fn minimal(case: Case) {
        run_case::<Minimal>(case).expect("capella rewards test should not return an error")
    }
