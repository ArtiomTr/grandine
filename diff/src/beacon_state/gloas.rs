...
use crate::{
    ...
    compress::Compressed,
    error::Error,
    list::{PositionalPatch, QueuePatch, VectorPatch},
...
pub struct GloasPatch<P: Preset> {
    ...
    builders: Compressed<PositionalPatch<Builder>>,
    next_withdrawal_builder_index: ReplacePatch<BuilderIndex>,
    execution_payload_availability: ReplacePatch<BitVector<SlotsPerHistoricalRoot<P>>>,
    builder_pending_payments: VectorPatch<BuilderPendingPayment>,
    ...
    payload_expected_withdrawals: PositionalPatch<Withdrawal>,
    ptc_window: Compressed<VectorPatch<Ptc<P>>>,
}
